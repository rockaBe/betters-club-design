  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/betterclubs-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/betterclubs-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build betterclubs-style-guide.gemspec && mv betterclubs-style-guide-' + userConfig.client.version + '.gem ../betterclubs-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install betterclubs-style-guide-' + userConfig.client.version + '.gem && rm betterclubs-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
